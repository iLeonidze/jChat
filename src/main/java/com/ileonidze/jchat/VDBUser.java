...
class VDBUser implements Serializable {
    ...
    boolean isPasswordsEqual(String password){ return this.password.equals(md5.proceed(password)); }
    ...
    List<String> getChatsIDs(){ return chatsIDs; }
    ...
    boolean getBannedState(){ return bannedState; }
